window.boot = function () {
  ...
  function setLoadingDisplay() {
    ...
    let isLoad50Track = false;
    let isLoad90Track = false;
    let isLoad95Track = false;
    let isLoad100Track = false;
